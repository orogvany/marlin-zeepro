...
*
****************************************************************************************/
#if MOTHERBOARD == 3 || MOTHERBOARD == 33 || MOTHERBOARD == 35
#define KNOWN_BOARD 1
...
// FC 20140711 Head PCB extruders inversion
...
// PNI 20140723 Invert ENDSTOP of two extruders
//#define PRIVATE_ENDSTOPS1  6
//#define PRIVATE_ENDSTOPS2  11
...
// FC 20140711 Head PCB fans inversion
//#define FAN_v2             45
#define FAN_v2             44
/*#define LED_color_Red	   32
#define LED_color_Green	   33
#define LED_color_blue	   35   // code marlinv11
 */ 
...
#else
// FC 20140711 Head PCB fans inversion
//#define FAN_PIN            44 // IO pin. Buffer needed
#define FAN_PIN            45 // IO pin. Buffer needed
#endif
#define PS_ON_PIN          12
...
#endif
#define HEATER_2_PIN       -1   
// FC 20140711 Head PCB thermistors inversion
...
#endif// MOTHERBOARD == 33 || MOTHERBOARD == 35
...
#endif//MOTHERBOARD == 3 || MOTHERBOARD == 33 ||  MOTHERBOARD == 35
...
#define SENSITIVE_PINS {0, 1, X_STEP_PIN, X_DIR_PIN, X_ENABLE_PIN, X_MIN_PIN, X_MAX_PIN, PRIVATE_ENDSTOPS1, PRIVATE_ENDSTOPS2, Endstop_voyage, Endstop_Z_Movement, Endstop_Carre, Y_STEP_PIN, Y_DIR_PIN, Y_ENABLE_PIN, Y_MIN_PIN, Y_MAX_PIN, Z_STEP_PIN, Z_DIR_PIN, Z_ENABLE_PIN, Z_MIN_PIN, Z_MAX_PIN, PS_ON_PIN, \
                        HEATER_BED_PIN, FAN_PIN,                  \
                        _E0_PINS _E1_PINS _E2_PINS             \
                        analogInputToDigitalPin(TEMP_0_PIN), analogInputToDigitalPin(TEMP_1_PIN), analogInputToDigitalPin(TEMP_2_PIN), analogInputToDigitalPin(TEMP_BED_PIN), analogInputToDigitalPin(ATMEL_IN_PUSH) }
#endif
