...
// Thermistor lookup table for Marlin - Zeepro v0.1 - see jcr for issues
// Based on sampled constructor datasheet - no use of theoritical beta
// createTemperatureLookup.py --rp=4700 --t1=25:100000 --t2=150:1628 --t3=230:294 --num-temps=71
// Correction de +5°C (mesurée : 180, réelle : 188) FC 28/06/2014 

#if (THERMISTORHEATER_0 == 77) || (THERMISTORHEATER_1 == 77) || (THERMISTORHEATER_2 == 77) || (THERMISTORBED == 77) 
const short temptable_77[][2] PROGMEM = {
{	1*OVERSAMPLENR , 	946	},
{	10*OVERSAMPLENR , 	349	},
{	11*OVERSAMPLENR , 	345	},
{	12*OVERSAMPLENR , 	340	},
...
{	85*OVERSAMPLENR , 	215	},
{	94*OVERSAMPLENR , 	210	},
{	103*OVERSAMPLENR , 	205	},
{	113*OVERSAMPLENR , 	200	},
{	124*OVERSAMPLENR , 	195	},
{	136*OVERSAMPLENR , 	190	},
{	149*OVERSAMPLENR , 	185	},
{	164*OVERSAMPLENR , 	180	},
{	181*OVERSAMPLENR , 	175	},
{	198*OVERSAMPLENR , 	170	},
{	218*OVERSAMPLENR , 	165	},
{	240*OVERSAMPLENR , 	160	},
{	263*OVERSAMPLENR , 	155	},
{	288*OVERSAMPLENR , 	150	},
{	316*OVERSAMPLENR , 	145	},
{	345*OVERSAMPLENR , 	140	},
{	376*OVERSAMPLENR , 	135	},
{	409*OVERSAMPLENR , 	130	},
{	444*OVERSAMPLENR , 	125	},
{	480*OVERSAMPLENR , 	120	},
{	517*OVERSAMPLENR , 	115	},
{	554*OVERSAMPLENR , 	110	},
{	593*OVERSAMPLENR , 	105	},
{	631*OVERSAMPLENR , 	100	},
{	668*OVERSAMPLENR , 	95	},
{	705*OVERSAMPLENR , 	90	},
{	740*OVERSAMPLENR , 	85	},
{	773*OVERSAMPLENR , 	80	},
...
{	986*OVERSAMPLENR , 	25	},
{	994*OVERSAMPLENR , 	20	},
{	1000*OVERSAMPLENR , 	15	},
{	1005*OVERSAMPLENR , 	10	},
{	1009*OVERSAMPLENR , 	5	}
};
#endif
