...
static bool old_e1_endstop=false;
bool Endstop_Left_avant=true;
bool Endstop_Left_apres=false;
bool Endstop_Right_avant=true;
bool Endstop_Right_apres=false;
...
{   
	...
	if (current_block != NULL) 
	{
		...
		if ((out_bits & (1<<E_AXIS)) != 0) {  // -direction
			...
			{
				/*#if PRIVATE_ENDSTOPS2 > -1
				bool e_min_endstop=(READ(PRIVATE_ENDSTOPS2) != E_ENDSTOPS_INVERTING);
...
#if PRIVATE_ENDSTOPS1 > -1
	SET_INPUT(PRIVATE_ENDSTOPS1); 
#ifdef ENDSTOPPULLUP_PRIVATE_ENDSTOPS1
	WRITE(PRIVATE_ENDSTOPS1,HIGH);
#endif
#endif

#if PRIVATE_ENDSTOPS2 > -1
	SET_INPUT(PRIVATE_ENDSTOPS2); 
#ifdef ENDSTOPPULLUP_PRIVATE_ENDSTOPS2
	WRITE(PRIVATE_ENDSTOPS2,HIGH);
#endif
#endif
